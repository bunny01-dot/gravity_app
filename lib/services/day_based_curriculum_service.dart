...
class DayBasedCurriculumService {
  ...
  Future<bool> loadVerbsCsv() async {
    ...
    try {
      ...
      debugPrint('OK: Verbs CSV loaded successfully: ${_verbItems.length} items');
  ...
  Future<void> fetchLatestVocabularyFromCloud() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('Error: Failed to download vocabulary: ${response.statusCode}');
