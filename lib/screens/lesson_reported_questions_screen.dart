...
// -----------------------------------------------------------------------------
// SCREEN: Direct & Indirect Speech
// -----------------------------------------------------------------------------
class LessonReportedQuestionsScreen extends StatefulWidget {
  const LessonReportedQuestionsScreen({super.key});

  @override
  State<LessonReportedQuestionsScreen> createState() =>
      _LessonReportedQuestionsScreenState();
}

class _LessonReportedQuestionsScreenState
    extends State<LessonReportedQuestionsScreen>
  ...
  // Base Asset Path
  final String _assetPath = 'assets/Lessons/Lesson_Reported_Questions/';
  ...
  final List<Map<String, dynamic>> _quizQuestions = [
    ...
    {
      'question': 'Mom asked, "Are you hungry?"  Mom asked ___ I was hungry.',
      'question_tamil':
  ...
  Future<void> _checkAndPlayHint() async {
    ...
    final hasSeenHint =
        prefs.getBool('has_seen_swipe_hint_lesson_reported_questions') ?? false;
    ...
    if (!hasSeenHint && mounted) {
      ...
      if (mounted && !_hasShownHint) {
        ...
        await prefs.setBool(
          'has_seen_swipe_hint_lesson_reported_questions',
          true,
        );
  ...
  void _initializeLessonContent() {
    _slides = [
      ...
      LessonSlide(
        ...
        content:
            "Direct Speech: Exact words (\"I eat dosa\").\n\nIndirect Speech: Reported (He said he ate dosa).\nSame message, different grammar!",
        imagePath: 'reported_questions_hook.webp',
        hindiContent: "Direct:   (\"   \")\nIndirect:   (     )",
        tamilContent: "Direct:  .\nIndirect:  .",
        imageFit: BoxFit.contain,
        formula: "Quoted vs Reported",
      ),
      // 2. Core Difference
      LessonSlide(
        title: "Direct vs Indirect",
        content:
            "DIRECT: Quote marks \" \". Exact words.\n\nINDIRECT: No quotes. Reported (that, if, to).\n\nRavi said, \"I eat.\" -> Ravi said that he ate.",
        imagePath: 'reported_questions_direct_indirect.webp',
        hindiContent: "DIRECT:    \nINDIRECT:    , reported ",
        tamilContent: "DIRECT:   .\nINDIRECT:   , reported .",
        imageFit: BoxFit.contain,
      ),
      // 3. Backshift
      LessonSlide(
        title: "Backshift Tense",
        content:
            "Present -> Past.\n\n\"I eat\" -> He ate.\n\"I am eating\" -> He was eating.\n\"I will eat\" -> He would eat.",
        imagePath: 'reported_questions_backshift.webp',
      ...
      LessonSlide(
        ...
        content:
            "Pronouns shift to match the speaker.\n\nI -> He/She.\nMy -> His/Her.\nYou -> I/Me.",
        imagePath: 'reported_questions_pronouns.webp',
        hindiContent: "      ",
        tamilContent: "   .",
        imageFit: BoxFit.contain,
      ),
      ...
      LessonSlide(
        ...
        imagePath: 'reported_questions_time_place_signpost.webp',
        hindiContent:
      ...
      LessonSlide(
        ...
        content:
            "Yes/No Questions -> Use \"if\".\nWH Questions -> Keep question word (\"where\").\n\n\"Are you hungry?\" -> Asked IF I was hungry.",
        imagePath: 'reported_questions_if_whether_mark.webp',
      ...
      LessonSlide(
        ...
        content:
            "Use \"to\" + Verb.\n\n\"Eat!\" -> Told me TO eat.\n\"Please help.\" -> Asked me TO help.",
        imagePath: 'reported_questions_commands_robot.webp',
        hindiContent: "\"to\" +    ",
        tamilContent: "\"to\" +  .",
        imageFit: BoxFit.contain,
      ),
      ...
      LessonMultiQuiz(
        ...
        questions: [
          {'text': '"I eat"', 'answer': 'He ate'},
          {'text': '"Are you ready?"', 'answer': 'Asked IF'},
          {'text': '"Study hard!"', 'answer': 'Told TO study'},
          {'text': '"Tomorrow"', 'answer': 'The next day'},
          {'text': '"My book"', 'answer': 'His book'},
        ],
      ),
      // 9. Mixed
      LessonSlide(
        ...
        content:
            "Statement: He would come.\nQuestion: Where it was.\nCommand: Warned NOT to.",
        imagePath: 'reported_questions_library_mixed.webp',
        hindiContent: " : , , ",
        tamilContent: " :  , , .",
        imageFit: BoxFit.contain,
      ),
      ...
      LessonSpeakingPractice(
        ...
        imagePath: 'reported_questions_speaking_mic.webp',
        prompts: [
          "He said he liked dosa.",
          "She asked if I was ready.",
          "Mom told me to eat.",
        ],
        exampleText: "He said he liked dosa",
        chartSummary:
            "Direct: 'I eat' -> Indirect: said HE ATE\n'Do you?' -> asked IF\n'Eat!' -> told TO eat",
        imageFit: BoxFit.contain,
      ),
    ];
  }
  ...
  Future<void> _loadProgress() async {
    ...
    bool storyDone =
        prefs.getBool('lesson_reported_questions_story_completed') ?? false;
    bool quizDone =
        prefs.getBool('lesson_reported_questions_quiz_completed') ?? false;
  ...
  Future<void> _saveProgress({
    ...
    try {
      ...
      if (storyCompleted) {
        await prefs.setBool('lesson_reported_questions_story_completed', true);
      }
      if (quizCompleted) {
        await prefs.setBool('lesson_reported_questions_quiz_completed', true);
        await prefs.setBool('lesson_reported_questions_completed', true);
        if (score != null) {
          await prefs.setInt('lesson_reported_questions_score', score);
        }
      }
        ...
        Expanded(
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: LessonImage(
                lessonId: 'lesson_reported_questions',
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _quizCompleted
                  ? "You have fully mastered Direct & Indirect Speech!\nGreat job!"
