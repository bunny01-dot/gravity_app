...
// -----------------------------------------------------------------------------
// SCREEN: Verbal Nouns (Gerunds)
// -----------------------------------------------------------------------------
class LessonVerbalNounsScreen extends StatefulWidget {
  const LessonVerbalNounsScreen({super.key});

  @override
  State<LessonVerbalNounsScreen> createState() =>
      _LessonVerbalNounsScreenState();
}

class _LessonVerbalNounsScreenState extends State<LessonVerbalNounsScreen>
  ...
  // Interactive States
  final Map<int, bool> _multiQuizSolved = {};

  // Lesson Content
  late List<LessonUnit> _slides;

  // Base Asset Path
  final String _assetPath = 'assets/Lessons/Lesson_Verbal_Nouns/';

  // Hardcoded Quiz (End of Lesson)
  final List<Map<String, dynamic>> _quizQuestions = [
    {
      'question': 'Which word is a Verbal Noun (Gerund)?',
      'question_tamil': 'Which word is a Verbal Noun (Gerund)?',
      'question_hindi': 'Which word is a Verbal Noun (Gerund)?',
      'options': ['Run', 'Running', 'Ran', 'Runs'],
      'correct': 1,
    },
    {
      'question': '"Swimming is fun." Swimming is the...',
      'question_tamil': '"Swimming is fun." Swimming is the...',
      'question_hindi': '"Swimming is fun." Swimming is the...',
      'options': ['Subject', 'Object', 'Verb', 'Adjective'],
      'correct': 0,
    },
    {
      'question': '"I like cooking." Cooking is the...',
      'question_tamil': '"I like cooking." Cooking is the...',
      'question_hindi': '"I like cooking." Cooking is the...',
      'options': ['Subject', 'Object', 'Adverb', 'Preposition'],
      'correct': 1,
    },
    {
      'question': 'Which sentence uses a Gerund?',
      'question_tamil': 'Which sentence uses a Gerund?',
      'question_hindi': 'Which sentence uses a Gerund?',
      'options': ['I am eating.', 'Eating is good.', 'She eats.', 'They eat.'],
      'correct': 1,
    },
    {
      'question': 'Gerunds act like which Part of Speech?',
      'question_tamil': 'Gerunds act like which Part of Speech?',
      'question_hindi': 'Gerunds act like which Part of Speech?',
  ...
  Future<void> _checkAndPlayHint() async {
    ...
    final hasSeenHint =
        prefs.getBool('has_seen_swipe_hint_lesson_verbal') ?? false;
    ...
    if (!hasSeenHint && mounted) {
      ...
      if (mounted && !_hasShownHint) {
        ...
        await prefs.setBool('has_seen_swipe_hint_lesson_verbal', true);
  ...
  void _initializeLessonContent() {
    _slides = [
      ...
      LessonSlide(
        title: "Verb or Noun?",
        content:
            "Swimming is fun -> Swimming is a NOUN here!\nI am swimming -> Swimming is a VERB here.\n\nVerbal Nouns explain actions as things.",
        imagePath: 'verbal_nouns_hook_square.webp',
        hindiContent:
            "Swimming is fun ->  Swimming   (Noun) !\nI am swimming ->     (Verb) ",
        tamilContent:
            "Swimming is fun ->  Swimming   (Noun)!\nI am swimming ->    (Verb).",
        imageFit: BoxFit.contain,
        formula: "The Gerund (Noun)",
      ),
      // 2. Definition
      LessonSlide(
        title: "The Gerund (-ing)",
        content:
            "A Gerund is a verb ending in -ing that acts as a Noun.\nIt names an activity rather than describing it happening.",
        imagePath: 'verb_vs_gerund_square.webp',
        hindiContent: "Gerund -ing         (Noun)      ",
        tamilContent: "Gerund  -ing   ,    (Noun) .",
        imageFit: BoxFit.contain,
      ),
      // 3. Subject Role
      LessonSlide(
        ...
        content:
            "A Gerund can be the HERO of the sentence.\n\nOK: SWIMMING is good exercise.\nOK: READING helps you learn.\nOK: SMOKING is bad for health.",
        imagePath: 'gerund_subject_square.webp',
        hindiContent: "SWIMMING is good..  'Swimming'  (Subject) ",
        tamilContent: "SWIMMING is good..  'Swimming'  (Subject).",
        imageFit: BoxFit.contain,
      ),
      // 4. Object Role
      LessonSlide(
        ...
        content:
            "A Gerund can also receive the action.\n\nOK: I enjoy COOKING.\nOK: Ravi loves PLAYING cricket.\nOK: She finished CLEANING her room.",
        imagePath: 'gerund_object_square.webp',
        hindiContent: "I enjoy COOKING.  'Cooking'  (Object) ",
        tamilContent: "I enjoy COOKING.  'Cooking'  (Object).",
        imageFit: BoxFit.contain,
      ),
      ...
      LessonSlide(
        ...
        content:
            "Always use a Gerund after words like: in, at, on, of, for.\n\nOK: Good AT singing.\nOK: Interested IN learning.\nOK: Famous FOR cooking.",
        imagePath: 'gerund_preposition_square.webp',
        hindiContent: "Prepositions (at, in, for)    Gerund  ",
        tamilContent: "Prepositions (at, in, for)    Gerund .",
        imageFit: BoxFit.contain,
      ),
      // 6. Comparison
      LessonSlide(
        ...
        content:
            "Gerund: I enjoy COOKING. (Facts/Real actions)\nInfinitive: I want TO COOK. (Plans/Future/Hypothetical)",
        imagePath: 'gerund_vs_infinitive_square.webp',
        hindiContent:
            "Gerund: I enjoy COOKING () Infinitive: I want TO COOK ()",
        tamilContent:
            "Gerund: I enjoy COOKING (). Infinitive: I want TO COOK ().",
        imageFit: BoxFit.contain,
      ),
      ...
      LessonSlide(
        title: "Verbs + Gerund",
        content:
            "Use Gerund after: Enjoy, Avoid, Finish, Stop, Quit, Mind.\n\nWrong: I enjoy to swim.\nRight: I enjoy swimming.",
        imagePath: 'gerund_verbs_square.webp',
        hindiContent: "Enjoy, Avoid, Finish, Stop     Gerund   ",
        tamilContent: "Enjoy, Avoid, Finish, Stop    Gerund .",
        imageFit: BoxFit.contain,
      ),
      // 8. Verbs with Infinitive
      LessonSlide(
        title: "Verbs + Infinitive",
        content:
            "Use Infinitive after: Want, Need, Hope, Decide, Plan, Promise.\n\nRight: I want to go.",
        imagePath: 'verbs_with_infinitive_square.webp',
        hindiContent: "Want, Need, Hope, Decide     Infinitive   ",
        tamilContent: "Want, Need, Hope, Decide    Infinitive .",
        imageFit: BoxFit.contain,
      ),
      // 9. Possessives
      LessonSlide(
        title: "With Possessives",
        content:
            "Use words like my, your, Ravi's before a Gerund.\n\nOK: My SINGING surprised them.\nOK: Ravi's DRIVING is safe.\nOK: Do you mind my SMOKING?",
        imagePath: 'possessive_gerund_square.webp',
        hindiContent: "Gerund   my, your, Ravi's   ",
        tamilContent: "Gerund   my, your, Ravi's .",
        imageFit: BoxFit.contain,
      ),
      // 10. Quiz 1
      LessonMultiQuiz(
        title: "Identify the Verbal Noun",
        questions: [
          {'text': 'Swimming is good.', 'answer': 'Swimming'},
          {'text': 'I like reading.', 'answer': 'Reading'},
          {'text': 'Stop talking!', 'answer': 'Talking'},
          {'text': 'Running is fast.', 'answer': 'Running'},
          {'text': 'She avoids eating.', 'answer': 'Eating'},
        ],
      ),
      // 11. Quiz 2
      LessonMultiQuiz(
        ...
        questions: [
          {'text': 'I enjoy ___ (play)', 'answer': 'Playing'},
          {'text': 'I want ___ (play)', 'answer': 'To play'},
          {'text': 'He decided ___ (go)', 'answer': 'To go'},
          {'text': 'Avoid ___ (smoke)', 'answer': 'Smoking'},
          {'text': 'Keep ___ (try)', 'answer': 'Trying'},
        ],
      ),
      // 12. Speaking
      LessonSpeakingPractice(
        title: "Speaking Practice",
        imagePath: 'gerund_speaking_square.webp',
        prompts: [
          "I enjoy reading books.",
          "Swimming is fun.",
          "Avoid eating sugar.",
        ],
        exampleText: "I enjoy reading books",
        chartSummary: "Gerunds act as Nouns.\nEnjoy + -ing\nWant + to...",
        imageFit: BoxFit.contain,
      ),
    ];
  }
  ...
  Future<void> _loadProgress() async {
    ...
    bool storyDone =
        prefs.getBool('lesson_verbal_nouns_story_completed') ?? false;
    bool quizDone =
        prefs.getBool('lesson_verbal_nouns_quiz_completed') ?? false;
  ...
  Future<void> _saveProgress({
    ...
    try {
      ...
      if (storyCompleted) {
        await prefs.setBool('lesson_verbal_nouns_story_completed', true);
      }
      if (quizCompleted) {
        await prefs.setBool('lesson_verbal_nouns_quiz_completed', true);
        await prefs.setBool('lesson_verbal_nouns_completed', true);
        if (score != null) {
          await prefs.setInt('lesson_verbal_nouns_score', score);
        }
      }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _quizCompleted
                  ? "You have fully mastered Verbal Nouns!\nGreat job!"
