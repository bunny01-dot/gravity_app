...
# Define image names
images_to_process = [
    "ravi_future_perfect_square",
    "future_perfect_timeline_square",
    "will_have_verb_table_square",
    "by_time_markers_square",
    "ravi_completion_timeline_square",
    "future_perfect_negative_square"
]

# Configure paths
brain_dir = r"C:\Users\HAPPY\.gemini\antigravity\brain\5ce4bb3f-1d3f-41c5-838e-8a0948fb4677"
target_dir = r"e:\Apps\gravity_app\assets\Lessons\Lesson_05_Tense_Future\03_Future_Perfect"
...
print(f"Processing {len(images_to_process)} images for Future Perfect...")
